...
.ant-btn-group .ant-btn-primary:not(:first-child):not(:last-child) {
  border-right-color: #26c2ed;
  border-left-color: #26c2ed;
}
...
.ant-fullcalendar-month-panel-current-cell .ant-fullcalendar-value {
  box-shadow: 0 0 0 1px #00A9E0 inset;
}
...
.ant-card-grid {
  ...
  border: 0;
  border-radius: 0;
  box-shadow: 1px 0 0 0 #33343c, 0 1px 0 0 #33343c, 1px 1px 0 0 #33343c, 1px 0 0 0 #33343c inset, 0 1px 0 0 #33343c inset;
  transition: all 0.3s;
}
.ant-card-grid:hover {
  position: relative;
...
.ant-radio-input:focus + .ant-radio-inner {
  box-shadow: 0 0 0 3px rgba(0, 169, 224, 0.08);
}
...
.ant-radio-button-wrapper:focus-within {
  outline: 3px solid rgba(0, 169, 224, 0.06);
}
...
.ant-radio-button-wrapper-checked:hover {
  color: #26c2ed;
  border-color: #26c2ed;
  box-shadow: -1px 0 0 0 #26c2ed;
}
.ant-radio-button-wrapper-checked:active {
  color: #0085ba;
  border-color: #0085ba;
  box-shadow: -1px 0 0 0 #0085ba;
}
