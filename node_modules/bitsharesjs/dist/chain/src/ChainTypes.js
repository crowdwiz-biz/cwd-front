...
ChainTypes.operations = {
    ...
    flipcoin_bet: 50, //GAMEZONE
    flipcoin_call: 51, //GAMEZONE
    flipcoin_win: 52, //VOP
    flipcoin_cancel: 53, //VOP
    flipcoin_loose: 54, //VOP,
    lottery_goods_create_lot: 55, //GAMEZONE
    lottery_goods_buy_ticket: 56, //GAMEZONE
    lottery_goods_send_contacts: 57, //GAMEZONE
    lottery_goods_confirm_delivery: 58, //GAMEZONE
    lottery_goods_win: 59, //VOP
    lottery_goods_loose: 60, //VOP
    send_message: 61,
    matrix_open_room: 62,
    matrix_room_closed: 63, //VOP
    matrix_cell_filled: 64 //VOP
};
