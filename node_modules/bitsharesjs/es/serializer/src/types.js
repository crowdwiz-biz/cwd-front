...
Types.string = {
    ...
    appendByteBuffer: function appendByteBuffer(b, object) {
        let size = new Blob([object]).size;
        v.required(object);
        b.writeVarint32(size);
        b.append(object.toString("utf8"), "utf8");
        return;
    },
    fromObject: function fromObject(object) {
        v.required(object);
...
Types.set = function (st_operation) {
    return {
        ...
        appendByteBuffer: function appendByteBuffer(b, object) {
            if (!object || (object && Object.keys(object).length === 0 && Object.getPrototypeOf(object) === Object.prototype)) {
                object = [];
            }
            b.writeVarint32(object.length);
