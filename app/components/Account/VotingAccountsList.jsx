            ...
            <React.Fragment>
                {this.props.width > 768 ? (
                    <tr className={isSupported ? "" : "unsupported"}>
                        ...
                        <td
                            className={
                                this.props.proxy
                                    ? ""
                                    : "clickable voting__action-btn-wrap"
                            }
                            onClick={
                                this.props.proxy
                                    ? () => {}
                        ...
                        >
                            {!this.props.proxy ? (
                                <NewIcon
                                    iconClass={
                                        isSupported ? "voting__vote-mark" : null
                                    }
                                    iconWidth={16}
                                    iconHeight={16}
                                    iconName={
                    ...
                    <div className="voting__card">
                        ...
                        <div className="voting__row">
                            <div className="voting__inner">
                                <div>
                                    <span className="voting__text">№ </span>
                                    <span className="voting__data">
                                        {this.props.idx + 1}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="voting__inner">
                                <Translate
                                    className="voting__text voting__text--column"
                        ...
                        <div className="voting__footer">
                            <div>
                                <Translate
                                    className="voting__text"
                            ...
                            <div className="voting__link-wrap">
        ...
        return (
            <div>
                ...
                {width > 768 ? (
                    ...
                    <div id="wrapperCard">{item_rows}</div>
                )}
            </div>
        );
    }
