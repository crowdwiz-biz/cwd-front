...
class AccountPermissionRow extends React.Component {
    ...
    render() {
        ...
        if (color) {
            colorRow = "permissions__row-add";
        } else {
            colorRow = "permissions__row-even";
        }
        ...
        return (
            <tr key={name} className={colorRow}>
            ...
            <div>
                ...
                >
                    <input
                        ...
                        className="cwd-common__input weight-input"
                        type="number"
                        autoComplete="off"
