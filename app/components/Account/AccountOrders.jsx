...
import {Input, Icon} from "crowdwiz-ui-modal";
                ...
                {orders && ordersCount ? (
                    <div>
                        <div className="account-orders__header">
                            <div className="account-orders__filter">
                                <input
                                    className="user-team__acc-filter user-team__acc-filter--no-margin user-team__acc-filter--border-radius"
                                    type="text"
                            ...
                            <div className="account-orders__btn-container">
                                <div className="account-orders__btn-wrap">
                    ...
                    <Translate content="account.no_open_orders" />
                )}
            </div>
        );
    }
