...
import AccountVesting from "./Vesting/AccountVesting";
        ...
        return (
            <section className="cwd-common__wrap">
                <Switch>
                    ...
                    />
                    <Route
                        path={`/account/${account_name}/portfolio`}
                        exact
                        render={() => <Portfolio {...passOnProps} />}
                    />
                    <Route
                    ...
                    {/* <Route
                            ...
                            /> */}
                    <Route
                        path={`/account/${account_name}/structure`}
                        exact
                        render={() => <AccountStructure {...passOnProps} />}
                    />
                </Switch>
                {/* {React.cloneElement(
