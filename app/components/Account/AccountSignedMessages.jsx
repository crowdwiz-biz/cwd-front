...
/** This component gives a user interface for signing and verifying messages with the crowdwiz memo key.
        ...
        return (
            <div className="grid-content app-tables no-padding" ref="appTables">
                <div className="content-block small-12">
                    <div className="tabs-container generic-bordered-box signed-messadges">
                        <Translate
                            component="h1"
                            content="account.signedmessages.header"
                            style={{color: "#fff"}}
                        />
                        <Tabs
                                    ...
                                    <span>
                                        ...
                                        {this.state.tabvm_verified !== null && (
                                            <div style={{float: "right"}}>
                                                <Translate content="account.signedmessages.message" />
                                                <div
                                                    style={{
