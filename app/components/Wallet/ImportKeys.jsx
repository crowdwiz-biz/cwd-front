...
class ImportKeys extends Component {
    ...
    /** CWD 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // CWD 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
    ...
    _parseWalletJson(json_contents) {
        ...
        let savePubkeyAccount = function(pubkey, account_name) {
            ...
            address = "CWD" + address.substring(3);
        ...
        try {
            ...
            if (!encrypted_brainkey)
                throw "Please use a CWD 1.0 wallet_export_keys file instead";
