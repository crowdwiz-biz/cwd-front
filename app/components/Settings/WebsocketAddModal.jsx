...
import {Modal, Button, Form, Input} from "crowdwiz-ui-modal";
    ...
    _renderAddModal() {
        ...
        return (
            <Modal
                ...
                id="ws_modal_add"
                className="cwd-ant-modal add-node-modal"
                ref="ws_modal_add"
                ...
                footer={[
                    ...
                    >
                        {counterpart.translate("modal.convert.submit")}
                    </Button>
                ]}
            >
    ...
    _renderRemoveModal() {
        ...
        return (
            <Modal
                ...
                footer={footer}
                className="cwd-ant-modal remove-node-modal"
                closable={false}
                width={475}
            >
                <div className="grid-content no-overflow">
                    <section className="block-list">
                        <p className="remove-node-modal__p">
                            <Translate
                                component="span"
