...
class WitnessRow extends React.Component {
    ...
    _onRowClick(e) {
        e.preventDefault();
        this.props.history.push(`/profile/${this.props.witness.get("name")}`);
    }
...
class WitnessList extends React.Component {
    ...
    render() {
        ...
        const columns = [
            ...
            {
                key: "name",
                title: counterpart.translate("explorer.witnesses.account"),
                dataIndex: "name",
                sorter: (a, b) => {
            ...
            },
            {
                ...
                title: counterpart.translate(
                    "explorer.witnesses.last_confirmed_block"
                ),
            ...
            },
            {
                key: "blocksMissed",
                title: counterpart.translate(
                    "explorer.witnesses.blocks_missed"
                ),
            ...
            {
                key: "votes",
                title: counterpart.translate("explorer.witnesses.votes"),
                dataIndex: "votes",
                render: item => (
                    <FormattedAsset
                        amount={item}
            ...
            {
                key: "key",
                title: counterpart.translate("explorer.witnesses.key"),
