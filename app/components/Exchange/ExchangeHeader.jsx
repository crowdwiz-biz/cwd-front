...
import { Icon as AntIcon } from "crowdwiz-ui-modal";
import { Asset, Price } from "common/MarketClasses";

import "./scss/market-header.scss";
...
export default class ExchangeHeader extends React.Component {
    ...
    _addMarket(base, baseId, quote, quoteId) {
        let allUserPairs = [];
    ...
    render() {
        ...
        let assetDataObj = {
            base: quoteAsset.get("id"),
            quote: baseAsset.get("id"),
            name: quoteSymbol + " - " + baseSymbol,
            link: quoteSymbol + "_" + baseSymbol,
        };
        ...
        const starClass = (localStorage.getItem("user_trade_pairs") && localStorage.getItem("user_trade_pairs").includes(assetDataStr))
            ? "favorite_star favorite_star--added"
            : "favorite_star";
                ...
                <div className="grid-block overflow-visible">
                    <div className="grid-block shrink">
                        <div style={{ padding: "10px" }}>
                            ...
                            <div className="market-header__label-actions">
                                <Translate
                                    className="market-header__stat-text"
                                ...
                                >
                                    <NewIcon
                                        iconClass="market-header__change-icon"
                                        iconWidth={"auto"}
                                        iconHeight={20}
                                        iconName={"shuffle"}
                                    />
