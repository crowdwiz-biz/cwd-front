...
import {Input} from "crowdwiz-ui-modal";
import NewIcon from "../NewIcon/NewIcon";

// STYLES
import "./scss/market-filter.scss";
...
class MyMarkets extends React.Component {
    ...
    render() {
        ...
        // let preferredBases = [coreSymbol, "BTC", "CWD", "CNY"];
        ...
        return (
            <div className={this.props.className} style={this.props.style}>
                ...
                {myMarketTab ? (
                    ...
                    >
                        <div>
                            <label className="market-filter__row">
                                <input
                                    className="market-filter__checkbox"
                                    type="checkbox"
                                ...
                                />
                                <span className="market-filter__text">
