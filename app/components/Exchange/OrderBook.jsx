...
import {Select, Tooltip} from "crowdwiz-ui-modal";
                        ...
                        <div>
                            ...
                            >
                                <table
                                    ...
                                    className="table order-table no-stripes table-hover fixed-table text-right"
                                >
                                    <TransitionWrapper
                                        ref="askTransition"
                                ...
                                <div className="cell cell-center">
                                    <span style={{width: 75}}>
                                        ...
                                        {!this.props.hideFunctionButtons ? (
                                            <NewIcon
                                                iconClass={
                                                    "icon-fill order-book-button-v clickable"
                                                }
                                                iconWidth={16}
                                                iconHeight={16}
                                                iconName={"thumb-tack"}
