...
const privKey = "5KZz884QdReN1gKA7oxZn57JkpvcagHXbQAe7XCUhSU3em4zgQp";
        ...
        for (let option of options) {
            ...
            if (option === "price_per_kbyte") {
                if (data.type === "memo" && !!data.content) {
                    ...
                    let memoFromKey =
                        "CWD5pVJXpeBzasw5nR2UNFBdcaqsRP2A1YbLxS9MSxuxqA24nFWSt";

                    // Memos are optional, but if you have one you need to encrypt it
                    let memoToKey =
                        "CWD5nZ8EFHTNE5m1cFT2DuRzXYgfGeYE48dmq5XtrPegfnqJ3PUrT";
