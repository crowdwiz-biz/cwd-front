...
const CORE_ASSET = "CWD"; // Setting this to CWD to prevent loading issues when used with CWD chain which is the most usual case currently
...
class SettingsStore {
    constructor() {
        ...
        this.bindListeners({
            ...
            onVerificationSet: SettingsActions.setVerifiactionWord,
    ...
    _getDefaultSetting() {
        return {
            verification: "",
            // serviceApi: ss.get("serviceApi"),
            locale: "en",
            apiServer: settingsAPIs.DEFAULT_WS_NODE,
            // apiServer: {
            //     url: "wss://cwd.global/ws",
            //     location: "Global"
            // },
    ...
    init() {
        return new Promise(resolve => {
            ...
            let topMarkets = {
                markets_4bb7d961: getMyMarketsQuotes(),
                markets_a88a1ecf: [
                    // TESTNET
                    "PEG.FAKEUSD",
                    "BTWTY"
            ...
            let bases = {
                markets_4bb7d961: getMyMarketsBases(),
                markets_a88a1ecf: [
                    // TESTNET
                    "TEST"
                ]
            ...
            let coreAssets = {
                markets_4bb7d961: "CWD",
                markets_a88a1ecf: "CWD"
            };
            let coreAsset = coreAssets[this.starredKey] || "CWD";
            /*
            ...
            let defaultBases = bases[this.starredKey] || bases.markets_4bb7d961;
    ...
    onVerificationSet({verification}) {
        this.onChangeSetting({setting: "verification", value: verification});
    }
    ...
    _getChainId() {
        return (Apis.instance().chain_id || "4bb7d961").substr(0, 8);
    }
